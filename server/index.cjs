...
app.use(
  cors({
    origin: ["http://localhost:5173", "https://www.manishasrivastava.in","https://manishasrivastav-production.up.railway.app","https://manisha-srivastav.vercel.app"], // allowed origins // change to your production domain later
